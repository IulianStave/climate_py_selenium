from src.common.Pages import CataloguePage
...
class ProductsCatalogueTest(BrowserTestCase):
    def test_catalogue_search_links(self):
        """ Clicks on the first product listed in catalogue page
            ...
            when clicked on
        """
        self.catalogue_page = CataloguePage(self.driver)
    ...
    def test_catalogue_products(self):
        """ Checks for the catalogue products div container
        """
        self.catalogue_page = CataloguePage(self.driver)
        self.catalogue_page.click(Locators.CATALOGUE_PRODUCTS)
